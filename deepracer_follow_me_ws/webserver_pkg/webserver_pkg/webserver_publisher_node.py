...
from webserver_pkg.constants import (VEHICLE_STATE_SERVICE,
                                     ...
                                     FOLLOW_ME_SET_MAX_SPEED_SERVICE,
...
class WebServerNode(Node):
    ...
    def __init__(self):
        ...
        # Create a reentrant callback group to call follow me max speed update service.
        set_followme_max_speed_cb_group = ReentrantCallbackGroup()
        self.get_logger().info("Create follow me set max speed service client: "
                               f"{FOLLOW_ME_SET_MAX_SPEED_SERVICE}")
        self.set_followme_max_speed_cli = self.create_client(SetFollowMeMaxSpeedSrv,
                                                             FOLLOW_ME_SET_MAX_SPEED_SERVICE,
                                                             callback_group=set_followme_max_speed_cb_group)
        self.wait_for_service_availability(self.set_followme_max_speed_cli)
