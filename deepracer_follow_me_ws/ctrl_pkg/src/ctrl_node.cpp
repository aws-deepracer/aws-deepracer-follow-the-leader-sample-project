...
namespace SysCtrl {
    ...
    #define FOLLOWME_DRIVE_TOPIC "/follow_me_navigation_pkg/follow_me_drive"
        ...
        void init(){
            if(!initialized_){
                stateList_ = { {autonomous, std::make_shared<SysCtrl::AutoDriveCtrl>(this->shared_from_this(), AUTO_DRIVE_TOPIC)},
                           ...
                           {followme, std::make_shared<SysCtrl::FollowMeDriveCtrl>(this->shared_from_this(), FOLLOWME_DRIVE_TOPIC)} };
